...
describe("Circle", ()=>{
    ...
    test("Should render circle",()=>{
        const circle = new Circle("red");
        expect(circle.render()).toBe('<circle cx="50%" cy="50%" r="80" fill="red"></circle>')
    })
})
...
describe("Triangle", ()=>{
    ...
    test("Should render triangle",()=>{
        const triangle = new Triangle("red");
        expect(triangle.render()).toBe('<polygon points="150, 43.75 206.25, 156.15 93.75, 156.15" fill="red" />')
    })
})
